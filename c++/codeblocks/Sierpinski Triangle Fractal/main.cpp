...
int main(int argc, char** args)
{
    ...
    while (!quit)
    {
        ...
        {
            generator->draw(renderer, genNumAle(0, 255), genNumAle(0, 255), genNumAle(0, 255), row-1); //Drawing the row in green color
